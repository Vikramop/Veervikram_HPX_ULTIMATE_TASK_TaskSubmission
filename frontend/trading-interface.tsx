    ...
    <div className="min-h-screen bg-gray-900 text-white p-4">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <TokenPairSelector tradingPairs={TRADING_PAIRS} selectedPair={selectedPair} onSelectPair={setSelectedPair} />
        </div>
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                ...
                <p className="text-2xl font-bold font-mono">${selectedPair.price.toFixed(6)}</p>
              </div>
              <div>
                <p className="text-gray-400 text-sm">24h Change</p>
                <p
                  className={`text-xl font-semibold flex items-center gap-1 ${selectedPair.change >= 0 ? "text-green-400" : "text-red-400"}`}
                >
              ...
              <div>
                ...
                <p className="text-xl font-semibold">{selectedPair.volume}</p>
              </div>
              <div>
                <p className="text-gray-400 text-sm">Market Cap</p>
                <p className="text-xl font-semibold">$45.2M</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Tabs defaultValue="chart" className="space-y-6">
          ...
          <TabsContent value="chart">
            <PriceChart selectedPair={selectedPair} candlestickData={candlestickData} />
          </TabsContent>
